            ...
            <v-card>
                ...
                <v-card-text>
                    <v-layout row wrap>
                        ...
                        <v-flex xs6 class="px-1 mb-2">
                            <!-- Disabled input when xact === 'edit' -->
                            <v-text-field v-if="xact === 'edit'" :value="selectedJurnalType.JurnalTypeName"
                                label="JURNAL TYPE" disabled hide-details outline></v-text-field>

                            <!-- Normal autocomplete when xact !== 'edit' -->
                            <v-autocomplete v-else v-model="selectedJurnalType" :items="jurnalTypeList" hide-no-data
                                hide-selected item-text="JurnalTypeName" label="JURNAL TYPE" hide-details outline
...
module.exports = {
    ...
    computed: {
        ...
        selectedJurnalType: {
            ...
            set(value) {
                this.$store.commit("terimaBarang/update_selectedJurnalType", value);
            },
        },
        jurnalTypeList() {
