...
class Samplesend extends MY_Controller
{
	  ...
	  if ($nolab != "") {
		...
		$sql = 	"SELECT T_OrderHeaderID,T_BarcodeLabID,T_BarcodeLabBarcode,T_SampleTypeName,T_OrderHeaderLabNumber,
				...
				JOIN t_ordersample ON T_OrderSampleT_OrderHeaderID = T_OrderHeaderID AND T_OrderSampleT_SampleTypeID = T_SampleTypeID AND 
					T_OrderSampleT_BarcodeLabID = T_BarcodeLabID AND T_OrderSampleVerification = 'Y' AND T_OrderSampleSendHandling = 'N' AND T_OrderSampleIsActive = 'Y'
				
				$sql_where
				GROUP BY T_BarcodeLabID
				ORDER BY T_OrderSampleVerificationDate ASC,T_OrderSampleVerificationTime ASC, T_OrderHeaderID ASC
				";
		//echo $sql;
   ...
   function getstationstatus(){
		...
		$sql = "SELECT T_SampleTypeID as id, T_SampletypeName as name
				...
				T_OrderSampleSendHandling = 'N' AND 
