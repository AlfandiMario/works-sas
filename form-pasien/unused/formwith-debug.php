...
// Debugging function to display session data
function debugSessionData()
{
    print_r($_SESSION['form_data']);
}

// Uncomment the line below to debug session data
// debugSessionData();
?>
...
<body>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="checkbox" name="<?php echo $detail['id_code']; ?>_ayah_chx"
                                            class="form-check-input border-black"
                                            <?php echo isset($savedData[$detail['id_code']]['ayah_chx']) && $savedData[$detail['id_code']]['ayah_chx'] ? 'checked' : ''; ?>>
                                    </td>
                                    <td>
                                        <input type="checkbox" name="<?php echo $detail['id_code']; ?>_ibu_chx"
                                            class="form-check-input border-black"
                                            <?php echo isset($savedData[$detail['id_code']]['ibu_chx']) && $savedData[$detail['id_code']]['ibu_chx'] ? 'checked' : ''; ?>>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </table>
    ...
    <script>
        ...
        console.log("Session Data:", <?php echo json_encode($_SESSION['form_data'] ?? []); ?>);
    </script>
</body>
