        ...
        <v-flex xs12 pl-2 pr-2 pt-2 pb-2>
          <v-data-table :headers="headers" :items="patients" :loading="isLoading" hide-actions
            ...
            <template slot="items" slot-scope="props">
              <td style="width: 10%" class="text-xs-center pa-2" v-bind:class="{
              ...
              <td style="width: 15%" class="text-xs-center pa-2" v-bind:class="{
                'amber lighten-4': isSelected(props.item),
                'teal white--text': props.item.coming === 'Y',
                amber: props.item.iscito === 'Y',
              }" @click="selectMe(props.item)">
              ...
              <td style="width: 20%" class="text-xs-center pa-2" v-bind:class="{
                'amber lighten-4': isSelected(props.item),
                'teal white--text': props.item.coming === 'Y',
                amber: props.item.iscito === 'Y',
              }" @click="selectMe(props.item)">
